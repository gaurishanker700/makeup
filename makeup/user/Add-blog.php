...
if(isset($_POST["submit"])) {
    ...
    $sql="INSERT INTO `blog` (`date`, `heading`, `description`, `content`, `image`) VALUES ('$date', '$heading', '$description', '$content', '$folder')";
    $result = mysqli_query($conn, $sql);
    if($result) {
        echo "<script>alert('Blog added successfully!')</script>";
        // header("Location: http://localhost/makeup/admin/Add-blog.php");
    } else{
        die("<p>Error adding blog post: " . mysqli_error($conn). "</p>");
    }
        ...
        <div class="row">
            ...
            <div class="col-lg-3 sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="addCourse.php"><i class="fas fa-plus"></i> Add Courses</a>
                    </li>
                    <li class="nav-item">
...
<div class="col-lg-9 main-content">
    ...
    <form action="Add-blog.php" method="POST" enctype="multipart/form-data" style="background-color: violet; padding: 20px; border-radius: 10px;">
    <div class="mb-3">
            <label for="date" class="form-label" style="color: pink;">Date</label>
            <input type="date" class="form-control" id="date" name="date" required style="border-color: pink;">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" name="submit" class="btn btn-primary" style="background-color: pink; border-color: pink;">Add Blog</button>
    </form>
</div>
