                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>";
                                    echo "<a href='/makeup/user/editCourse.php?id=" . $row["id"] . "' class='btn btn-outline-primary'>Edit</a> <br> ";
                                    echo "<a href='deleteCourse.php?id=" . $row["id"] . "' class='btn btn-outline-danger'>Delete</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
